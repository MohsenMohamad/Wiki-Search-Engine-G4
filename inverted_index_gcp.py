...
PROJECT_ID = 'ir-final-project-64871'
...
class InvertedIndex:  
    def __init__(self, docs={}):
        ...
        """
        # stores document length (number of words in document)
        self.dl = {}
        # stores average document length of all documents in index
        self.avg_dl = 0
        # stores document frequency per term (number of documents where term appears)
        self.df = Counter()
